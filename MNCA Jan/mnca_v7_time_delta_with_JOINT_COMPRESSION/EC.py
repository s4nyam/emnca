...
def crossover(parent1,parent2):
    ...
    # return [c1,c2]
    return [[randomListGenerator(),randomListGenerator()],[randomListGenerator(),randomListGenerator()]]
...
print(x)
print("printing DEFLATEs of LOWEST, MEAN and BEST")
print(y)
