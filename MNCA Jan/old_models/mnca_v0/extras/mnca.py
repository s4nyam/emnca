from extras.util import ca, initialize
...
animation = FuncAnimation(fig, animate, 10)

# plt.show()

animation.save('./genCA.gif', writer='PillowWriter')
plt.close('all')


print("Generation Finished with B: "+str(B)+" and S: " + str(S))
...
print("With deflate size: ",deflate_size)